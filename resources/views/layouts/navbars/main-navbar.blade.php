                ...
                <div style="display: flex; gap: 16px; align-items: center; font-size: 14px; font-weight: 500; flex-wrap: nowrap; overflow: visible;">
                    ...
                    <div style="display: flex; gap: 12px; align-items: center; flex-wrap: nowrap;">
                        ...
                        <a href="{{ route('reviews.index') }}" style="
                                    ...
                                    transition: all 0.2s ease;
                                    white-space: nowrap;
                                " onmouseover="this.style.background='rgba(245, 158, 11, 0.08)'; this.style.borderColor='rgba(245, 158, 11, 0.2)'"
                            onmouseout="this.style.background='rgba(245, 158, 11, 0.04)'; this.style.borderColor='rgba(245, 158, 11, 0.1)'">
