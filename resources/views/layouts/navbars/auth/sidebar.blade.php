...
<li class="nav-item">
    <a class="nav-link {{ Request::is('admin/posts/reactions*') ? 'active' : '' }}" href="{{ route('admin.posts.reactions.index') }}">
        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-smile text-dark"></i>
        </div>
        <span class="nav-link-text ms-1">Reactions Management</span>
    </a>
</li>
        </ul>
    </div>
