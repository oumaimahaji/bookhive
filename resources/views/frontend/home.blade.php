        ...
        <div class="flex flex-col lg:flex-row items-center justify-between">
            <div class="lg:w-1/2 mb-12 lg:mb-0 text-left">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    @guest
                    <a href="{{ route('register.create') }}" class="group border-2 border-white text-white hover:bg-white hover:text-gray-900 font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center">
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            ...
            <div class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden border border-gray-100">
                ...
                <!-- Contenu de la carte -->
                <div class="p-4">
                    <h3 class="font-bold text-gray-900 mb-2 line-clamp-2 text-sm">{{ $book->titre }}</h3>
                    <p class="text-gray-600 text-xs mb-3">Par {{ $book->auteur }}</p>

                    @if($book->description)
                    <p class="text-gray-700 text-xs line-clamp-2 mb-3">{{ Str::limit($book->description, 80) }}</p>
                    @endif
                    ...
                    <a href="{{ route('frontend.book', $book->id) }}"
                        class="w-full bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold py-2 px-4 rounded-lg transition-colors duration-200 block text-center">
                        📖 Voir détails
                    </a>
                    @else
                    <a href="{{ route('login') }}"
                        class="w-full bg-gray-600 hover:bg-gray-700 text-white text-xs font-semibold py-2 px-4 rounded-lg transition-colors duration-200 block text-center">
                        🔒 Se connecter
                    </a>
                    @endauth
                </div>
...
<section class="py-20 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 relative overflow-hidden">
    ...
    <div class="relative z-10 container mx-auto px-6 text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            @guest
            <a href="{{ route('register.create') }}" class="group bg-white text-gray-900 hover:bg-gray-100 font-bold py-4 px-8 rounded-2xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl flex items-center justify-center">
