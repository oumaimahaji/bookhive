    ...
    document.addEventListener('DOMContentLoaded', function() {
        setTimeout(function() {
            ...
            if (content === 'none' || content === '') {
                console.log('Chargement de FontAwesome de secours...');
...
<style>
    .fontawesome-fallback .fa-robot:before {
        content: "🤖";
        font-family: initial;
    }

    .fontawesome-fallback .fa-plus:before {
        content: "➕";
        font-family: initial;
    }

    .fontawesome-fallback .fa-times:before {
        content: "❌";
        font-family: initial;
    }

    .fontawesome-fallback .fa-exclamation-triangle:before {
        content: "⚠️";
        font-family: initial;
    }
</style>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (form) {
            form.addEventListener('submit', function() {
                console.log('Case cochée ?', forceCheckbox ? forceCheckbox.checked : 'non défini');
            });
        }
