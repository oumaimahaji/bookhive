    ...
    <div class="container-fluid py-4">
        <div class="row mb-3">
            ...
            <div class="col-6 text-end">
                ...
                @if(isset($club))
                    <a href="{{ route('admin.clubs.index') }}" class="btn btn-secondary">Retour aux Clubs</a>
                @endif
            </div>
        </div>
                                    ...
                                    <select name="club_id" class="form-control" required>
                                        ...
                                        @foreach($clubs as $clubItem)
                                            <option value="{{ $clubItem->id }}" {{ old('club_id') == $clubItem->id ? 'selected' : '' }}>
                                                {{ $clubItem->nom }} (Manager: {{ $clubItem->createur->name ?? 'N/A' }})
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('club_id')
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.events.update', $editEvent->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md-6 mb-3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <select class="form-control" onchange="if(this.value) window.location.href='{{ route('admin.events.index') }}?club_id=' + this.value">
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    @php
                                        $isPastEvent = $event->date_event && \Carbon\Carbon::parse($event->date_event)->isPast();
                                    @endphp
                                    <tr>
                                        <td>
                                        ...
                                        <td class="align-middle text-center text-sm">
                                            ...
                                            @else
                                                <span class="badge badge-sm bg-gradient-success">À venir</span>
                                            @endif
                                        </td>
                                        <td class="align-middle text-center">
                                            <div class="btn-group" role="group">
                                                <a href="{{ route('admin.events.index', ['edit' => $event->id]) }}"
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="7" class="text-center p-3">Aucun événement trouvé.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
