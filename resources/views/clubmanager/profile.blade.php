                ...
                <div class="col-auto my-auto">
                    <div class="h-100">
                        ...
                        <p class="mb-0 font-weight-bold text-sm">
                            👥 {{ ucfirst(auth()->user()->role) }} • Manager since {{ auth()->user()->created_at->format('M Y') }}
                        </p>
                    </div>
                </div>
            ...
            <div class="col-12 col-xl-4">
                <div class="card h-100">
                    <div class="card-header pb-0 p-3">
                        <h6 class="mb-0">Club Manager Settings</h6>
                    </div>
                    <div class="card-body p-3">
                        <h6 class="text-uppercase text-body text-xs font-weight-bolder">Club Management</h6>
                        <ul class="list-group">
                            <li class="list-group-item border-0 px-0">
                                <div class="form-check form-switch ps-0">
                                    <input class="form-check-input ms-auto" type="checkbox" id="joinRequests" checked>
                                    <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0" for="joinRequests">
                                        Notify for join requests
                                    </label>
                                </div>
                            </li>
                            <li class="list-group-item border-0 px-0">
                                <div class="form-check form-switch ps-0">
                                    <input class="form-check-input ms-auto" type="checkbox" id="eventReminders" checked>
                                    <label class="form-check-label text-body ms-3 text-truncate w-80 mb-0" for="eventReminders">
                                        Event reminders
                                    </label>
                                </div>
                            </li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="profile" role="tabpanel">
                        <div class="card h-100 mb-4">
                            ...
                            <div class="card-body p-3">
                                <form method="POST" action="{{ route('club_manager.profile.update') }}" id="profileForm">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-control-label">Manager Since</label>
                    ...
                    <div class="tab-pane fade" id="password" role="tabpanel">
                        <div class="card h-100 mb-4">
                            ...
                            <div class="card-body p-3">
                                <form method="POST" action="{{ route('club_manager.password.update') }}" id="changePasswordForm">
                                    @csrf
                                    <div class="form-group">
