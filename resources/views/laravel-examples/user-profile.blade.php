            ...
            <div class="row gx-4">
                ...
                <div class="col-auto my-auto">
                    <div class="h-100">
                        ...
                        <p class="mb-0 font-weight-bold text-sm">👑 {{ ucfirst(auth()->user()->role) }} • Admin since {{ auth()->user()->created_at->format('M Y') }}</p>
                    </div>
                </div>
                                    ...
                                    <form method="POST" action="{{ route('user-password.update') }}" id="changePasswordForm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" type="password" id="current_password" name="current_password" required minlength="1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" type="password" id="new_password" name="new_password"
                                                    ...
                                                    title="Le mot de passe doit contenir au moins 8 caractères, une majusc
                                            ...
                                            <div class="form-text text-xs">Min. 8 caractères, avec majuscule, minuscule, chiffre et symbole</div>
                                            @error('new_password')
                                            <div class="text-danger text-xs">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" type="password" id="new_password_confirmation" name="new_password_confirmation" required minlength="8">
                                                <span class="input-group-text toggle-password">
                                                    <i class="fas fa-eye"></i>
                                                </span>
                                            </div>
