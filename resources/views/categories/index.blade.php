...
=======
                                        ...
                                        <td class="align-middle text-center">
                                            <div class="d-flex justify-content-center gap-2">
                                                ...
                                                <form action="{{ route('categories.destroy', $category->id) }}" method="POST" style="display:inline;" 
                                                      class="delete-form" data-category-name="{{ $category->nom }}">
                                                    @csrf
                                                    @method('DELETE')
...
=======
                            <div class="text-center p-4">
                                <p class="text-muted mb-0">
                                    ...
                                    @else
                                    No categories found. <a href="{{ route('categories.create') }}">Create the first category</a>
                                    @endif
                                </p>
                            </div>
>>>>>>> 688c610 (Ajout CRUD + FRONT ET BACK + API +AI Reservation et Review)
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Confirmation de suppression avec le nom de la catégorie
